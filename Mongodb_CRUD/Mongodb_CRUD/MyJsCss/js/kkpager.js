    ...
    generPageHtml: function (config, enforceInit) {
        ...
        if (this.isShowCurrPage) {
            ...
            if (this.isShowTotalPage) {
                ...
                total_info += this.lang.totalPageBeforeText + '<span class="totalPageNum"  style="color:red;">' + this.total + '</span>' + this.lang.totalPageAfterText;
                total_info += total_info_splitstr;
                total_info += this.lang.totalRecordsBeforeText + '<span class="totalRecordNum" style="color:red;">' + this.totalRecords + '</span>' + this.lang.totalRecordsAfterText;
